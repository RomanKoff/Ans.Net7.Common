...
namespace Ans.Net7.Common
{
        ...
        : List<RegistryItem>
    {
        ...
        public Registry(
            ...
            : this()
        {
            Type type1 = items.GetType().GetGenericArguments()[0];
            ...
            string newKey = null)
        {
            ...
            if (key1 != null)
                return key1;
            Add(newKey ?? this.Count.ToString(), value);
            return newKey;
        }
        ...
        {
            return GetProposeControl(Count, GetMaxWidth());
        }
        ...
        public void Add(
            ...
            int level)
        {
            var item1 = new RegistryItem(key, value, level);
            Add(item1);
        ...
        public void FillFromString(
            string source)
        {
            FillFromString(source.ScreeningReg().Split(';'));
        }
