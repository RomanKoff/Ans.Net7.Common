namespace Ans.Net7.Common
{
    ...
    public static class SuppMath
    {
		 ...
		 * int RoundToInt(decimal value);
		 * double Map(double value, double fromMin, double fromMax, double toMin, double toMax, bool crop);
		 * int Map(int value, int fromMin, int fromMax, int toMin, int toMax, bool crop = true);
		 * int GetNextDivisible(int value, int div = 8);
		 * float GetNextDivisible(float value, int div = 8);
		 * int GetRestrict(int value, int minLimit, int maxLimit);
		 * long GetRestrict(long value, long minLimit, long maxLimit);
		 * double GetRestrict(double value, double minLimit, double maxLimit);
		 * float GetRestrict(float value, float minLimit, float maxLimit);
		 * decimal GetRestrict(decimal value, decimal minLimit, decimal maxLimit);
		 * DateTime GetRestrict(DateTime value, DateTime minLimit, DateTime maxLimit);
		 * int GetRangeIndex(int value, params int[] points)
		 */
